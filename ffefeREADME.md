...
do
	...
	if placeId == 4442272183 then --- Blox Fruit New World
		...
		local L9s0 = library.new("9s0 Hub - Blox Fruit (New World)")
		...
		S9s08:addButton("Copy Link Discord",function()
			...
			setclipboard("https://discord.gg/fXpC7pQR")
		end)

		S9s08:addButton("Credit",function()

			L9s0:Notify("CREDIT ", "BlackList Hub")
			wait(2.5)
			L9s0:Notify("CREDIT ", "Src By 9s0 Hub Thx you form BlackList")
		end)
	end

	if placeId == 189707 then --- Natural Disaster Survival

		if game.CoreGui:FindFirstChild("BlackList Hub - Natural Disaster Survival") then
			game.CoreGui:FindFirstChild("BlackList Hub - Natural Disaster Survival"):Destroy()
		end
